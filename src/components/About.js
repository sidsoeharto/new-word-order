  ...
  return (
    <section className="flex flex-col container-fluid min-h-72 py-16 lg:px-32 lg:py-16 text-center" style={{background: '#e5e5e5'}}>
      <div className="flex justify-center text-center py-4 px-4 lg:p-16">
        <h1 className="text-3xl lg:text-4xl font-bold mb-2" style={{color: "#009AC6"}}>This could be your starting line for the 2032 games in Brisbane. </h1>
      </div>
      <div className="flex flex-col lg:flex-row justify-center lg:px-64">
        <div className="flex-1 w-full lg:mx-4 justify-center px-10">
          <div className="mb-8">
            <p className="text-white text-black text-left">
      ...
      <div className="flex justify-center text-center p-8 lg:p-16">
        <h1 className="text-2xl font-bold mb-2">This could be the first step in your Olympic journey. <span className="text-4xl" style={{color: '#F0534D'}}> Good luck! </span></h1>
      </div>
