function Register() {
  return (
    <section 
      className="flex flex-col container-fluid min-h-72 lg:px-64 py-16 text-center" 
      style={{
    ...
    >
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-4/12 px-6 mx-auto justify-center">
          <div className="py-10">
            <h1 className="text-white text-4xl lg:text-5xl text-left mb-8">Register Now!</h1>
            <p className="text-white text-base lg:text-xl text-left">
              Register your details and create an account. When applications open in
              December, we’ll let you know.   
            </p>
          </div>
        </div>
        <div className="w-full lg:w-8/12 px-6 lg:px-32 mx-auto justify-center">
